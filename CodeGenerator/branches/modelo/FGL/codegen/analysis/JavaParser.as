package codegen.analysis
{
	...
	public class JavaParser implements ICodeParser
	{
		...
		public function parseCode(javaCode:String):Array
		{
			...
			javaCode = javaCode.replace(/\/\*.*\*\//g, ""); /* one line */
			javaCode = javaCode.replace(/\/\*.*?\*\//sg, ""); /* multiline */
		...
		private function getASEquivType(pJavaType:String):String
		{
			...
			if(pJavaType=="String") return "String";			
			if(pJavaType=="Date") return "Date";			
			if(pJavaType=="Calendar") return "Date";			
			if(pJavaType=="GreogianCalendar") return "Date";			
			if(pJavaType=="Map") return "Object";			
			if(pJavaType=="Dictionnary") return "Object";			
			if(pJavaType=="Document") return "XML";						
			if(pJavaType=="ArrayList") return "ArrayCollection";			
			if(pJavaType=="List") return "ArrayCollection";			
			if(pJavaType=="Long") return "Object";			
			if(pJavaType=="Integer") return "Object";			
			if(pJavaType=="Double") return "Object";			
			if(pJavaType=="Float") return "Object";			
